...
//handles all the actions of the bullets
class BulletHandler {
    constructor(game) {
        this.game = game;
    ...
    //create the bullet as it leaves the gun
    ...
    //update the positon of the bullet
    update(dt) {
        this.bullets.forEach(bullet => {
            ...
            //if the bullet has shot the player or enemy remove it from the scene
            if (hit) {
                target.action = 'shot';
        ...
        //track bullets that are not on the scene
        let found = false;
        do {
            let remove;
